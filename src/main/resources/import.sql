...
-- Bloc
INSERT INTO tb_bloc (start, end_time, activity_id) VALUES (TIMESTAMP WITH TIME ZONE '2017-09-25T08:00:00Z', TIMESTAMP WITH TIME ZONE '2017-09-25T11:00:00Z', 1);
INSERT INTO tb_bloc (start, end_time, activity_id) VALUES (TIMESTAMP WITH TIME ZONE '2017-09-25T14:00:00Z', TIMESTAMP WITH TIME ZONE '2017-09-25T18:00:00Z', 2);
INSERT INTO tb_bloc (start, end_time, activity_id) VALUES (TIMESTAMP WITH TIME ZONE '2017-09-26T08:00:00Z', TIMESTAMP WITH TIME ZONE '2017-09-26T11:00:00Z', 2);

-- Participant_activity
-- José Silva participa do Curso de HTML
INSERT INTO tb_participant_activity (participant_id, activity_id) VALUES (1, 1);
-- Tiago Faria participa do Curso de HTML
INSERT INTO tb_participant_activity (participant_id, activity_id) VALUES (2, 1);
-- Maria do Rosário participa do Curso de HTML
INSERT INTO tb_participant_activity (participant_id, activity_id) VALUES (3, 1);
-- Tiago Faria participa da Oficina de Github
INSERT INTO tb_participant_activity (participant_id, activity_id) VALUES (2, 2);
-- Maria do Rosário participa da Oficina de Github
INSERT INTO tb_participant_activity (participant_id, activity_id) VALUES (3, 2);
-- Teresa Silva participa da Oficina de Github
